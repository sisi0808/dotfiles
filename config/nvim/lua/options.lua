...
vim.opt.shiftwidth = 2 -- インテンドをスペース二つ分
...
vim.opt.clipboard = "unnamed" -- コピーしたときはクリップボードを使用
vim.opt.nobackup = true -- バックアップファイルを作らない
vim.opt.noswapfile = true -- スワップファイルを作らない
vim.opt.autoread = true -- 編集中のファイルが変更されたら、自動的に読み込み直す
vim.opt.wildmenu = true -- 補完の強化
vim.syntax.on() -- シンタックスをオン
