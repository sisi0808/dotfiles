...
-- カーソル移動
vim.api.nvim_set_keymap('n', '<leader>4', '$', { noremap = true })
vim.api.nvim_set_keymap('n', '<leader>6', '^', { noremap = true })
...
-- タブ設定
-- 新規タブをホームディレクトリで
vim.api.nvim_set_keymap('n', '<C-t>', ':tabe ~/<CR>', { noremap = true })
-- 新規タブを同じディレクトリで
-- vim.api.nvim_set_keymap('n', '<C-t>', ':tabe<CR>', { noremap = true })
...
vim.api.nvim_set_keymap('n', '<leader>wr', ':new ~/.config/nvim/init.lua<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>ww', ':source ~/.config/nvim/init.lua<CR>', { noremap = true, silent = true })
...
-- Digraph設定
-- vim.api.nvim_set_keymap('n', 'fj', 'f<C-k>', { noremap = true })
-- vim.api.nvim_set_keymap('n', 'Fj', 'F<C-k>', { noremap = true })
-- vim.api.nvim_set_keymap('n', 'tj', 't<C-k>', { noremap = true })
-- vim.api.nvim_set_keymap('n', 'Tj', 'T<C-k>', { noremap = true })
